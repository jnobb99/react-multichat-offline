...
export default function ChatSidebar({
    ...
    return (
        <>
            ...
            <aside
                className={`fixed inset-y-0 left-0 z-20 flex w-72 flex-col bg-stone-900 p-4 text-stone-100 transition-transform duration-200 md:static md:w-72 md:translate-x-0 ${isOpen ? 'translate-x-0' : '-translate-x-full md:translate-x-0'
                    }`}
            >
                ...
                <nav aria-label="Lista de conversas" className="flex flex-col gap-2 overflow-y-auto">
                    {chatIds.length === 0 ? (
